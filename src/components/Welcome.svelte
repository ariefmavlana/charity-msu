...
<section class="xs-welcome-slider">
    <div class="xs-banner-slider owl-carousel">
        <div class="xs-welcome-content" style="background-image: url(public/assets/images/slide1.png);">
            <div class="container">
        ...
        <div class="xs-welcome-content" style="background-image: url(public/assets/images/slide2.png);">
            <div class="container">
                <div class="xs-welcome-wraper color-white">
        ...
        <div class="xs-welcome-content" style="background-image: url(public/assets/images/slide3.png);">
            <div class="container">
                <div class="xs-welcome-wraper color-white">
